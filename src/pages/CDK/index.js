  ...
  const reactContent = [
    {
      title: "Installation",
      description:
        "You will need Node, Typescript, AWS CLI, CDK CLI (npm i -g cdk), and a configured AWS Account (aws configure)",
...
mkdir cdk && cd cdk && cdk init app --language typescript`,
    },
    {
      title: "CDK Structure",
      description:
        "In the CDK, there is a single-to-many relationship from App -> Stack -> Construct. Each stack has three props, (scope, id, props). Constructs also have three props, (the stack it belongs to, its name, options.)",
...
const bucket = new Bucket(this, "CreateReactAppBucket", {
  ...
  const fn = new lambda.Function(this, 'MyFunction', {
    ...
    },
    {
      ...
      description:
        "With this construct, you can deploy a single page application to CloudFront quick and easy. Make sure you download the required dependencies.",
      code: `import * as cdk from '@aws-cdk/core';
